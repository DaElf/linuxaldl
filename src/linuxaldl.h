...
#define __MAX_REQUEST_SIZE                                                                                                                 \
	16 // maximum size (bytes) of a request message                                                                                    \
		// to send to the ECM
...
float aldl_raw8_to_float(u_char val, int operation, float op_factor, float op_offset);
...
float aldl_raw16_to_float(u_char msb, u_char lsb, int operation, float op_factor, float op_offset);
